        ...
        <div className="w-64 h-screen sticky top-0 border-r border-border bg-sidebar flex flex-col p-6">
            ...
            <div className="pt-6 border-t border-border mt-auto">
                <div className="flex items-center space-x-3 mb-6 p-2 rounded-xl bg-secondary/50">
                    ...
                    <div>
                        <p className="text-sm font-semibold">Alex Developer</p>
                        <p className="text-xs text-muted-foreground">{unlockedSkills.length} Badges Earned</p>
                    </div>
                </div>
                <button className="flex items-center text-sm font-medium text-muted-foreground hover:text-destructive transition-colors w-full px-2">
